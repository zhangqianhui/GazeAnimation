...
class TestOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--crop_h', type=int, default=92, help='the size of cropped eye region')
        parser.add_argument('--crop_w_p', type=int, default=200, help='the padding version for cropped size')
        parser.add_argument('--crop_h_p', type=int, default=128, help='the padding version for cropped size')
